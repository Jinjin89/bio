...
curl -L -C -  https://api.gdc.cancer.gov/data/c0008693-0583-4eac-bd5c-583070763893   --proxy "http://<user_name>:<passwd>@<address>:<port>"
...
2. configure the docker
    ...
    1. Where the docker save its images?
